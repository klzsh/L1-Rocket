...
accel_x = cleanedData.MAX;
accel_y = cleanedData.MAY;
accel_z = cleanedData.MAZ;
...
for i = 2:numEntries(1,1)
    ...
    x = x_dist(i)+randn(1)*std_error/2 ;
    y = y_dist(i)+randn(1)*std_error/2;
    z = alt(i) + randn(1)*std_error - 16.2;
